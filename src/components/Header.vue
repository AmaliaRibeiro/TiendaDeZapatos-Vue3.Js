        ...
        <div class="container-xl">
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            <td>
                                                ...
                                                :alt="'imagen zapato' + producto.nombre"
                                                >
                                            </td>
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    <h1 class="display-2 fw-bold">Modelo de oferta! {{ zapato.nombre }}</h1>
                    <p class="mt-5 fs-5 text-white">{{ zapato.descripcion }}</p>
                    <p class="text-primary fs-1 fw-black">${{zapato.precio}}</p>
                    <button
                        type="button" 
                        class="btn fs-4 bg-primary text-white py-2 px-5"
                        @click="$emit('agregar-carrito', zapato)">Agregar al Carrito</button>
                </div>
            </div>
        </div>
